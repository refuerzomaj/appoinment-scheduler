...
public class CustomerController {
 ...
 @GetMapping("/new/{customer_type}")
   ...
   @PostMapping("/delete")
    public String processDeleteCustomerRequest(@RequestParam("customerId") int customerId, RedirectAttributes redirectAttributes) {
        try {
            userService.deleteUserById(customerId);
            return "redirect:/customers/all";
        } catch (Exception ex) {
            redirectAttributes.addFlashAttribute("deleteError", "Cannot delete the student due to existing appointment.");
            return "redirect:/customers/all";
        }
    }
