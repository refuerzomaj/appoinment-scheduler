...
public class ProviderController {
   ...
   @PostMapping("/delete")
    public String processDeleteProviderRequest(@RequestParam("providerId") int providerId, RedirectAttributes redirectAttributes) {
        try {
            userService.deleteUserById(providerId);
            return "redirect:/providers/all";
        } catch (Exception ex) {
            redirectAttributes.addFlashAttribute("deleteError", "Cannot delete the provider due to existing appointment.");
            return "redirect:/providers/all";
        }
    }
