...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendAppointmentFinishedNotification(Appointment appointment) {
        ...
        context.setVariable("appointment", appointment);
         context.setVariable("url", baseUrl + "https://www.facebook.com/PhilscaOfficial/");
    ...
    public void sendAppointmentCanceledByCustomerNotification(Appointment appointment) {
        ...
        sendEmail(appointment.getProvider().getEmail(), "Appointment cancelled by Customer", "appointmentCanceled", context, null);
    }
    ...
    public void sendAppointmentCanceledByProviderNotification(Appointment appointment) {
        ...
        sendEmail(appointment.getCustomer().getEmail(), "Appointment cancelled by Provider", "appointmentCanceled", context, null);
    }
